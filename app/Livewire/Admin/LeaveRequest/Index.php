...
class Index extends Component
{
    ...
    public ?string $status = LeaveRequest::STATUS_PENDING_HR;
    ...
    {
        return view('livewire.admin.leave-request.index');
    }
    ...
    public function statusStats(): array
    {
        ...
        return [
            ...
            'pending_hr' => $requests->where('status', LeaveRequest::STATUS_PENDING_HR)->count(),
            'approved_by_hr' => $requests->where('hr_id', Auth::id())->whereNotNull('hr_approved_at')->count(),
