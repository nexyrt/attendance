<div class="space-y-6">
        ...
        <x-table :$headers :$sort :rows="$this->rows" selectable wire:model="selected" paginate filter loading>
            ...
            @if($row->department)
                <div class="flex items-center space-x-2">
                    <div class="w-3 h-3 rounded-full {{ match($row->department->name) {
            ...
            <div class="text-sm">
                ...
                <div class="text-xs text-gray-500 dark:text-gray-400">{{ $row->created_at->diffForHumans() }}</div>
            </div>
            @endinteract
    ...
    <div x-data="{ show: @entangle('selected').live }" x-show="show.length > 0" x-transition
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-600 px-4 sm:px-6 py-4 sm:min-w-96">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="font-semibold text-gray-900 dark:text-gray-50" x-text="`${show.length} karyawan dipilih`"></div>
