<div>
    <x-modal :title="$user ? 'Edit: ' . $user->name : 'Edit Karyawan'" wire size="2xl">
        @if($user)
            <form id="user-update" wire:submit="save" class="space-y-4">
            ...
            <x-slot:footer>
                <div class="flex justify-between w-full">
                    ...
                    <x-button type="submit" form="user-update" color="green" loading="save" icon="check">
                        Update Karyawan
                    </x-button>
                </div>
            </x-slot:footer>
