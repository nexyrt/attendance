<div>
    <div class="flex justify-between items-center mb-6">
        ...
        <livewire:office-management.create @created="$refresh" />
    </div>
    ...
    <x-table :headers="$this->getHeaders()" :sort="$sort" :rows="$this->getRows()" paginate filter loading>
        ...
        @interact('column_action', $row)
            <div class="flex gap-1">
                ...
                <livewire:office-management.delete :office="$row" :key="uniqid('', true)" @deleted="$refresh" />
            </div>
        @endinteract
    </x-table>

    <livewire:office-management.update @updated="$refresh" />
</div>
